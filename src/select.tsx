	...
	function SelectTrigger(props, forwardedRef): JSX.Element {
		...
		return (
			<SelectPrimitive.Trigger
				ref={forwardedRef}
				className={cn(
					"flex h-10 w-full items-center justify-between rounded-md border border-neutral-300 bg-transparent py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-neutral-400 dark:border-neutral-700 dark:text-neutral-50 dark:focus:ring-neutral-400 dark:focus:ring-offset-neutral-900",
					className,
				)}
				{...rest}
			>
