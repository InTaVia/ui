	...
	return (
		...
		>
			<SwitchPrimitives.Thumb
				className={cn(
					"pointer-events-none block h-5 w-5 rounded-full bg-neutral-0 shadow-lg ring-0 transition-transform data-[state=unchecked]:tranneutral-x-0 data-[state=checked]:tranneutral-x-5",
				)}
			/>
		</SwitchPrimitives.Root>
	);
